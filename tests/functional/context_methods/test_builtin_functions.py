...
class TestContextBuiltins:
    ...
    def test_builtin_invocation_args_dict_function(self, project):
        ...
        expected = "'send_anonymous_usage_stats': False, 'event_buffer_size': 100000, 'quiet': False, 'no_print': False, 'macro': 'validate_invocation', 'args': '{my_variable: test_variable}', 'which': 'run-operation', 'rpc_method': 'run-operation', 'anonymous_usage_stats': True, 'indirect_selection': 'eager'}"
        assert expected in str(result)
